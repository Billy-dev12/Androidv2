...
- Ekstraksi isi berkas `.tar.md5` dilakukan ke folder output utama menggunakan `ExtractTarRaw`, lalu dekompresi dilakukan secara otomatis lewat perintah sistem `lz4 -d -f`.
